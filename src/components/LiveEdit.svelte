<script>
    ...
    <button type="button" class="settings-icon" on:click={openSettingsLink} aria-label="Open Live Edit link">
        <!-- SVG for the settings icon -->
  ...
  <style>
    /* Style for the settings icon container */
    .settings-icon {
      cursor: pointer;
      width: 24px;
      height: 24px;
