...
Explore **OMNIPEDIA** — 6 million Wikipedia articles transformed into immersive 3D worlds on a live global map. Build apps, games, and experiences in seconds with the **HOLODECK** — no coding required.<br>

And as the community shapes OMNIPEDIA and in turn the HOLODECK, a Genie 3 class spatial AGI emerges from it.<br>

Think owning collectively Google Maps, Wikipedia, Amazon, Airbnb, Couchsurfing, Uber, DoorDash, UpWork, Fiverr, Spontacts, the whole gig, meet, and marketplace economy, Twitch, Kickstarter, and an App & Game Store with Genie 3 class spatial AGI — raised by the open-source community. 🔥<br>
...
- **No matchmaking server required** – handles signaling automatically.  
